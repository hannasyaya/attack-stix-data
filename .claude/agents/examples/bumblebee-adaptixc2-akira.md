...
| 4 | Execution | MSI copied to a network share, then run by an IT admin from `explorer.exe` | T1204.002 Malicious File; T1218.007 Msiexec *(inferred — the report does not name `msiexec.exe`)* |
